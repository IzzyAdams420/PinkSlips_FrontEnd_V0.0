...
let AddressManagerAddress = "0xe636920b4c62f9419a670fBbdBFE6A5A955F8aFc";
...
module.exports = function (deployer) {
  ...
  deployer.then(async () => {
   ...
   //                       theCourtAddress, miniBailiff);
    ...
    await deployer.deploy(PinkSlips, AddressManagerAddress);
    //await deployer.deploy(GoldStars, AddressManagerAddress);
  ...
  .then(async () => {
    ...
    //await deployer.deploy(JuryPool, AddressManagerAddress);
    //await deployer.deploy(DisputeMachine, AddressManagerAddress);
  }) .then(async () => {
